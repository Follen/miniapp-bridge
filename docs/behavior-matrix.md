...
- `Contexts`, `SelectContext`, and `SubscribeContexts` map to both
  ...
  request resolves through the shared CDP correlator and later client enables
  remain idempotent.
